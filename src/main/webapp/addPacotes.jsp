		...
		<header id="header" >
		    ...
		    <nav id="nav">
		      ...
		      <ul id="menu" role="menu" class="bg-warning drop-warning">
				...
				<li><a href="/addPacotes.jsp" exact>Cadastrar Pacotes</a></li>	
				<li><a href="CriarEncontrar" exact>Lista de Pacotes</a></li>
				<li><a href="" exact>Atendimento</a></li>
				<li><a href="/cadastrarUsuario.html" exact>Cadastre-se</a></li>		
		      </ul>
		    </nav>
		  </header>
<div class="container">
	<div class="row">
		<div class="cold-md-7">
			...
			<hr>
			<form action="CriarEncontrar" method="POST">
				<div class="form-floating mb-3">
						<input name="nome" maxlength="200" type="text" class="form-control" id="floatingInput1"> 
						<label>Nome do Pacote</label>
					</div>
					<div class="form-floating mb-3">
						<input name="origem" maxlength="200" type="text" class="form-control"> 
						<label>Seu Local de Origem</label>
					</div>
					<div class="form-floating mb-3">
						<input name="destino" maxlength="200" type="text" class="form-control"> 
						<label>Seu Destino</label>
					</div>
					<div class="form-floating mb-3">
						<input name="saida" type="date" class="form-control" placeholder="Saida">
						<label>Saída</label>
					</div>
					<div class="form-floating mb-3">
					...
					<div class="form-floating mb-3">
						<input name="preco_Unt" type="decimal" class="form-control" placeholder="Preço Unitário">
						<label>Preço Unitário</label>
					</div>
					<div class="form-floating mb-3">
						<input name="inform_add" type="text" class="form-control" placeholder="Informações">
