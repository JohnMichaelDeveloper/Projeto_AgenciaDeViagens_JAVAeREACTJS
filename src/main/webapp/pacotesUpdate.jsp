		...
		<header id="header" >
		    ...
		    <nav id="nav">
		      ...
		      <ul id="menu" role="menu" class="bg-warning drop-warning">
				...
				<li><a href="/cadastrarPacote.html" exact>Cadastrar Pacotes</a></li>
				<li><a href="CriarEncontrar" exact>Lista de Pacotes</a></li>
				
				<li><a href="" exact>Atendimento</a></li>
				<li><a href="Criar" exact>Lista de Pacotes</a></li>
				<li><a href="/cadastrarPacote.html" exact>Cadastre-se</a></li>
...
<div class="container">
	<div class="row">
		<div class="cold-md-7">
			<hr>
			<h3>Atualizar Pacote</h3>
			<hr>
			<form action="PacoteUpdate" method="POST">
					<input value="${pacote.idPacotes}" name="idPacotes" type="number" style="visibility:hidden">
					<div class="form-floating mb-3">
						<input value="${pacote.nome}" name="nome" maxlength="200" type="text" class="form-control" id="floatingInput1"> 
						<label>Nome do Pacote</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${pacote.origem}" name="cpf" maxlength="200" type="text" class="form-control"> 
						<label>Seu Local de Origem (apenas números)</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${pacote.destino}" name="nome" maxlength="200" type="text" class="form-control" id="floatingInput1"> 
						<label>Seu Destino</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${pacote.saida}" name="saida" type="date" class="form-control" placeholder="Saida">
						<label>Saida</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${pacote.retorno}" name="retorno" type="date" class="form-control" placeholder="Retorno">
						<label>Retorno</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${pacote.preco_Unt}" name="preco_Unt" maxlength="decimal" type="text" class="form-control" id="floatingInput1"> 
						<label>Preço Unitário</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${pacote.inform_add}" name="inform_add" maxlength="500" type="text" class="form-control" id="floatingInput1"> 
