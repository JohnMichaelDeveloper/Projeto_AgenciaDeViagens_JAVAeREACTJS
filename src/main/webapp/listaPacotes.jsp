...
<br>
<form action="CriarEncontrar" method="GET" class="d-flex">
		...
		<div class="cold-md-7">
			...
			<table class="table">
				...
				<c:forEach items="${pacotes}" var="pacote">
							<tr>
								<td>${pacote.idPacotes}</td>
								<td>${pacote.nome}</td>
								<td>${pacote.origem}</td>
								<td>${pacote.destino}</td>
								<td>${pacote.saida}</td>
								<td>${pacote.retorno}</td>
								<td>${pacote.preco_Unt}</td>
								<td>${pacote.inform_add}</td>
								<td>
									<a href="PacoteDestroy?pacoteIdPacotes=${pacote.idPacotes}">deletar</a> |
									<a href="PacoteUpdate?pacoteIdPacotes=${pacote.idPacotes}">atualizar</a>
								</td>
							</tr>
						</c:forEach>
				</tbody>
