		...
		<header id="header" >
		    ...
		    <nav id="nav">
		      ...
		      <ul id="menu" role="menu" class="bg-warning drop-warning">
				...
				<li><a href="Criar" exact>Lista de Atendimento</a></li>
...
<div class="container">
	<div class="row">
		<div class="cold-md-7">
			...
			<hr>
			<form action="AtendimentoUpdate" method="POST">
				<div class="form-floating mb-3">
						<input value="${atendimento.nome}" name="nome" maxlength="40" type="text" class="form-control" id="floatingInput1"> 
						<label>Nome</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${atendimento.email}" name="email" maxlength="200" type="text" class="form-control" id="floatingInput1">
						<label>Email</label>
					</div>
					<div class="form-floating mb-3">
						<input value="${atendimento.data_do_atend}" name="data_do_atend" type="date" class="form-control"> 
						<label>Data do Atendimento</label>
					</div>
				
					<div class="form-floating mb-3">
						<input value="${atendimento.duvida}" name="duvida" rows="5" cols="30" maxlength="200" type="text" class="form-control" >
						<label>Qual é Sua Dúvidas?</label>
					</div>
					<div class="form-floating mb-3">
					<input value="${atendimento.satisfacao}" name="satisfacao" maxlength="2" type="text" class="form-control" id="floatingInput1"> 								 
