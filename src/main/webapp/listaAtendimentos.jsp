		...
		<div class="cold-md-7">
			...
			<table class="table">
				...
				<c:forEach items="${atendimentos}" var="atendimento">
							<tr>
								<td>${atendimento.idAtend}</td>
								<td>${atendimento.nome}</td>
								<td>${atendimento.email}</td>
								<td>${atendimento.data_do_atend}</td>
								<td>${atendimento.duvida}</td>
								<td>${atendimento.satisfacao}</td>
								<td>
									<a href="AtendimentoDestroy?atendimentoIdAtend=${atendimento.idAtend}">deletar</a> |
									<a href="AtendimentoUpdate?atendimentoIdAtend=${atendimento.idAtend}">atualizar</a>
								</td>
							</tr>
						</c:forEach>
				</tbody>
